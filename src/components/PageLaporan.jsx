...
import { TrashIcon, PrinterIcon, ChevronDownIcon, DownloadIcon } from './Icons';
...
function LaporanRiwayatKasbon({ kasbon, formatCurrency, formatDate, handleCetak, pegawai }) {
    const [filters, setFilters] = useState({ startDate: '', endDate: '', pegawaiId: 'semua' });
    const handleFilterChange = (e) => { const { name, value } = e.target; setFilters(prev => ({ ...prev, [name]: value })); };
...
// --- Sub-komponen Laporan Data Pegawai & Produk ---
...
function PageLaporan({ riwayatGajian, kasbon, formatCurrency, formatDate, handleRiwayatGajianDelete, transaksi, pegawai, produk, showNotification, handleCetakSlip, handleCetakStrukKasbon }) {
    ...
    return (
        <div>
            ...
            <div>
                ...
                {activeReport === 'riwayatKasbon' && <LaporanRiwayatKasbon kasbon={kasbon} formatCurrency={formatCurrency} formatDate={formatDate} handleCetak={handleCetakStrukKasbon} pegawai={pegawai} />}
